<template>
    <div class="flex flex-col">
        ...
        <div class="mt-16 sm:mt-32">
            ...
            <div class="mb-6">
                <input class="text-gray-900 bg-blue-100 placeholder:text-gray-500 appearance-none border border-blue-200 rounded w-full p-2 mt-2 focus:outline-none" :placeholder="$t('label.search_projects')" v-model="search">
            </div>
